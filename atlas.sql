...
-- ----- 部门 -----
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `dept_name`, `sort`, `leader`, `phone`, `status`, `create_by`, `create_time`) VALUES
(1, 0, 'Atlas科技',  0, 'admin', '15888888888', 0, 'admin', NOW()),
(2, 1, '研发部',     1, NULL,    NULL,           0, 'admin', NOW()),
(3, 1, '产品部',     2, NULL,    NULL,           0, 'admin', NOW()),
(4, 1, '运维部',     3, NULL,    NULL,           0, 'admin', NOW());

-- ----- 角色 -----
INSERT INTO `sys_role` (`role_id`, `role_name`, `role_key`, `sort`, `status`, `create_by`, `create_time`) VALUES
(1, '超级管理员', 'admin',  1, 0, 'admin', NOW()),
(2, '普通角色',   'common', 2, 0, 'admin', NOW());

-- ----- 用户（密码明文: admin123，生产环境请使用BCrypt加密） -----
INSERT INTO `sys_user` (`user_id`, `username`, `nickname`, `password`, `email`, `phone`, `sex`, `avatar`, `status`, `dept_id`, `create_by`, `create_time`) VALUES
(1, 'admin', '超级管理员', 'admin123', 'admin@atlas.com', '15888888888', 1, '', 0, 1, 'admin', NOW()),
(2, 'atlas', '普通用户',   'admin123', 'atlas@atlas.com', '15888888889', 1, '', 0, 2, 'admin', NOW());

-- ----- 菜单（一级目录） -----
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `sort`, `path`, `component`, `menu_type`, `perms`, `icon`, `visible`, `status`, `create_by`, `create_time`) VALUES
(1, '系统管理', 0, 1, 'system',  NULL,                  'M', NULL,               'system',  0, 0, 'admin', NOW()),
(2, '系统监控', 0, 2, 'monitor', NULL,                  'M', NULL,               'monitor', 0, 0, 'admin', NOW()),
(3, '基础设施', 0, 3, 'infra',   NULL,                  'M', NULL,               'infra',   0, 0, 'admin', NOW());

-- ----- 菜单（系统管理 - 二级菜单） -----
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `sort`, `path`, `component`, `menu_type`, `perms`, `icon`, `visible`, `status`, `create_by`, `create_time`) VALUES
(10, '用户管理', 1, 1, 'user', 'system/user/index', 'C', 'system:user:list', 'user',     0, 0, 'admin', NOW()),
...
-- ----- 菜单（用户管理 - 按钮权限） -----
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `sort`, `path`, `component`, `menu_type`, `perms`, `icon`, `visible`, `status`, `create_by`, `create_time`) VALUES
(100, '用户查询', 10, 1, '', NULL, 'F', 'system:user:query',  '#', 0, 0, 'admin', NOW()),
...
-- ----- 菜单（系统监控 - 二级菜单） -----
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `sort`, `path`, `component`, `menu_type`, `perms`, `icon`, `visible`, `status`, `create_by`, `create_time`) VALUES
(20, '在线用户', 2, 1, 'online', 'monitor/online/index', 'C', 'monitor:online:list', 'online', 0, 0, 'admin', NOW()),
(21, '服务监控', 2, 2, 'server', 'monitor/server/index', 'C', 'monitor:server:list', 'server', 0, 0, 'admin', NOW());

-- ----- 菜单（基础设施 - 二级菜单） -----
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `sort`, `path`, `component`, `menu_type`, `perms`, `icon`, `visible`, `status`, `create_by`, `create_time`) VALUES
(30, '文件管理', 3, 1, 'file',    'infra/file/index',    'C', 'infra:file:list',    'upload',   0, 0, 'admin', NOW()),
(31, '代码生成', 3, 2, 'codegen', 'infra/codegen/index', 'C', 'infra:codegen:list', 'code',     0, 0, 'admin', NOW());
...
(1,  1, '未知', '0', 'sys_user_sex',      0, 'admin', NOW()),
